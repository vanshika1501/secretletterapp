...
function HeroSection() {
  ...
  <section className="flex flex-col md:flex-row justify-between mx-auto max-w-[1248px] pt-24 md:pt-24 px-6 md:px-8">
      ...
      <motion.div
        ...
        className="max-w-xl"
      >
        <p className="text-3xl text-description font-shifty md:text-lg lg:text-3xl">Hey There! I'm</p>
        <h1 className="text-4xl md:text-6xl font-shifty my-5 md:leading-[75px] ">
          <TypeAnimation
            sequence={[
              'Vanshika Sharma', 2000,
        ...
        <p className=" text-description font-shifty text-3xl mb-9 md:text-lg lg:text-3xl">
          crafting secure, scalable
          applications and exploring the power of AI to build smarter tech for tomorrow.
        </p>
        <a className="inline-block rounded-3xl bg-purple3 cursor-pointer" href="#contact">
          <span onClick={downloader} className="flex items-center gap-2 w-full h-full bg-purple border border-purple3 px-6 py-3 rounded-3xl lg:text-lg font-semibold transition-all duration-300 -translate-x-1 -translate-y-1 hover:-translate-x-2 hover:-translate-y-2">
      ...
      >
        <div className="relative">
          <img src="/illustrations/vanshika.png" alt="" className="select-none" ref={characterRef} />
          <img
