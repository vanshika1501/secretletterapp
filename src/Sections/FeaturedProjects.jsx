...
function FeaturedProjects() {
  ...
  return (
    <section className="pt-24 md:pt-32" id="projects">
      <motion.h2
        className="text-center text-5xl mb-14 font-motley dark:text-white"
      ...
      <div className="flex flex-col sm:flex-row w-screen">
        <div className="sm:w-1/2 relative overflow-hidden min-h-[400px] md:min-h-[70vh] ">
       <img src="/images/Pro1.webp" alt="Animated preview" className="w-full h-auto border-4 border-purple2 rounded-xl" />
        ...
        <div className="flex flex-col justify-center sm:w-1/2 p-8 sm:p-12">
          <div className="max-w-5xl mr-auto" >
            ...
            >
              ...
              <Tag text="Multimodal Learning" color="purple" />
              <Tag text="Transfer Learning" color="purple4" />
              <Tag text="XAI" color="purple" />

            </motion.div>
            <motion.h3
              className="text-3xl font-motley  mb-2 text-purple4"
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.5 }}
              transition={{ duration: 0.3, delay: 0.3, ease: "backOut" }}
            ...
            <motion.p
              className="text-description font-shifty text-2xl mb-4 dark:text-white"
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.5 }}
              transition={{ duration: 0.3, delay: 0.3, ease: "backOut" }}
            ...
            <motion.a
              className="text-md font-bold group text-purple4 hover:text-black"
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.5 }}
              transition={{ duration: 0.3, delay: 0.3, ease: "backOut" }}
